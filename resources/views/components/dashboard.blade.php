...
<body class="min-h-screen bg-cover bg-slate-50">
    <div name="dashboard_sidebar">
        <x-sidebar>
        </x-sidebar>

        <div name="dasboard_navbar" class="p-4 xl:ml-80">
            <nav
...
<div class="bg-gray-50/50 text-blue-gray-600">
    <footer class="py-2">
